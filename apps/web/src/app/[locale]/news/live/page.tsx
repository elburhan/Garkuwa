...
const copy = getMessages('en').publicNews;
export const metadata: Metadata = {
  title: `${copy.latestLiveUpdates} | ${getMessages('en').common.siteName}`,
  description: copy.liveUpdatesIntroduction,
  alternates: {
    canonical: absolute('/en/news/live'),
    languages: { ha: absolute('/news/live'), en: absolute('/en/news/live') },
  },
};
export const revalidate = 60;

export default async function EnglishLiveUpdatesPage({
  params,
  searchParams,
}: Readonly<{
  ...
  const result = await loadPublicNews('en', { page, pageSize: 20, category: 'live-updates' });
